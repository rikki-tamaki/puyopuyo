class Score {
    ...
    static initialize() {
        ...
        for(let i = 0; i < 10; i++) {
            ...
            if(fontWidth === 0) {
                fontWidth = fontImage.width / fontImage.height * webkitConvertPointFromPageToNode.fontHeight;
            }
    ...
    static showScore() {
        ...
        for(let i = 0; i < this.fontLength; i++) {
            // 10で割った余りを求めて、一番下の桁を取り出す
            const number = score % 10;
            // 一番後ろに追加するのではなく、一番前に追加することで、スコアの並びを数字と同じようにする
